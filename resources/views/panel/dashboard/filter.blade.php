    <div class1="btn-controls">
        <div class="btn-box-row1 row">
            <button class="btn-box big col-md-4 homepage-form-box" id="findbookbox">
                <i class="icon-list"></i>
                <b>Find Book</b>
            </button>

            <button class="btn-box big col-md-4 homepage-form-box" id="findissuebox">
                <i class="icon-book"></i>
                <b>Find Issue Book </b>
            </button>

            <button class="btn-box big col-md-4 homepage-form-box" id="findstudentbox">
                <i class="icon-user"></i>
                <b>Find Student</b>
            </button>
        </div>
