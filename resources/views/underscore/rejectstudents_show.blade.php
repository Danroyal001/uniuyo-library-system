...
<tr data-student-id="<%= obj.student_id %>">
    ...
    <td><%= obj.category %></td>
    <td>
        <a class="btn btn-success student-status" data-status="approved" data-table="rejected-table">Approve</a>
        <a class="btn btn-danger student-status" data-status="delete" data-table="rejected-table">Delete</a>
    </td>
</tr>
