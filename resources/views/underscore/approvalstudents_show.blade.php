...
<tr data-student-id="<%= obj.student_id %>">
    ...
    <td><%= obj.category %></td>
    <td>
        <a class="btn btn-success student-status" data-status="approved" data-table="new-table">Approve</a>
        <a class="btn btn-danger student-status" data-status="rejected" data-table="new-table">Reject</a>
    </td>
</tr>
